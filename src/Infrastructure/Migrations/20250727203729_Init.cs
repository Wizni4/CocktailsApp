    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubMemberToClubRole", x => new { x.ClubRoleId, x.ClubMemberId });
                    table.ForeignKey(
                        name: "FK_ClubMemberToClubRole_ClubMember_ClubMemberId",
                        column: x => x.ClubMemberId,
                        principalTable: "ClubMember",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubMemberToClubRole_ClubRole_ClubRoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubMemberToClubRole_ClubMemberId",
                table: "ClubMemberToClubRole",
                column: "ClubMemberId");
