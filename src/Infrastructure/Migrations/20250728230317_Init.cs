    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CocktailIngredient", x => new { x.CocktailId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubRole_Permissions", x => new { x.ClubRoleId, x.Id });
                    table.ForeignKey(
                        name: "FK_ClubRole_Permissions_ClubRole_ClubRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubMember_Permissions", x => new { x.ClubMemberId, x.Id });
                    table.ForeignKey(
                        name: "FK_ClubMember_Permissions_ClubMember_ClubMemberId",
