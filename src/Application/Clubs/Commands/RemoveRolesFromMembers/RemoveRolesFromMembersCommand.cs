...
namespace CocktailsApp.Application.Clubs
{
    ...
    /// <param name="Members">The unique identifier of the member to whom the role is being removed.</param>
    /// <param name="RoleId">The list of unique identifiers of roles to remove.</param>
    /// <param name="ActorId">
    ...
    /// </param>
    public sealed record RemoveRolesFromMembersCommand(
        Guid ClubId,
        IEnumerable<MemberRolesUpdateModel> Members,
        Guid RequestId
    ) : ClubCommand<Unit>(ClubId), IIdempotentCommand
    {
        public string IdempotencyKey => $"RemoveRolesFromMembers:{RequestId}";
    }
}
