...
namespace CocktailsApp.Application.Club
{
    ...
    ) : IQueryHandler<GetClubCocktailsByIdsQuery, IEnumerable<ClubCocktailDTO>>
    {
        ...
        public Task<IEnumerable<ClubCocktailDTO>> Handle(GetClubCocktailsByIdsQuery request, CancellationToken cancellationToken)
        {
            return _clubCocktailQueries.ReadRangeAsync(
                new ClubCocktailByIdsQuerySpecification(request.ClubId, request.CocktailIds));
        }
    }
}
