...
{
    /// <summary>
    /// Handles the <see cref="RemovePermissionsToMemberCommand"/> by permission from a club member.
    /// </summary>
    ...
    public class RemovePermissionsToMemberCommandHandler(IUnitOfWork unitOfWork, IMapper autoMapper)
        : ClubCommandHandler<RemovePermissionsToMemberCommand>(unitOfWork, autoMapper), ICommandHandler<RemovePermissionsToMemberCommand, ClubDTO>
    {
        ...
        /// </exception>
        public override async Task<ClubDTO> Handle(RemovePermissionsToMemberCommand request, CancellationToken cancellationToken)
        {
            ...
            club.RemovePermissionsToMember(request.MemberId, request.Permissions, request.ActorId);
