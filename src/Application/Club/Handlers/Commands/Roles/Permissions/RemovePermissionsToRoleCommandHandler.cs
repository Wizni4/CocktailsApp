...
{
    /// <summary>
    /// Handles the <see cref="RemovePermissionsToRoleCommand"/> by removing a permission from a club role.
    /// </summary>
    ...
    public class RemovePermissionsToRoleCommandHandler(IUnitOfWork unitOfWork, IMapper autoMapper)
        : ClubCommandHandler<RemovePermissionsToRoleCommand>(unitOfWork, autoMapper), ICommandHandler<RemovePermissionsToRoleCommand, ClubDTO>
    {
        ...
        /// </exception>
        public override async Task<ClubDTO> Handle(RemovePermissionsToRoleCommand request, CancellationToken cancellationToken)
        {
            ...
            club.RemovePermissionsToRole(request.RoleId, request.Permissions, request.ActorId);
