...
{
    /// <summary>
    /// Handles the <see cref="UpdateAddressCommand"/> by updating the club address.
    /// </summary>
    ...
    public class UpdateAddressCommandHandler(IUnitOfWork unitOfWork, IMapper autoMapper)
        : ClubCommandHandler<UpdateAddressCommand>(unitOfWork, autoMapper), ICommandHandler<UpdateAddressCommand, ClubDTO>
    {
        private readonly IUnitOfWork _unitOfWork = unitOfWork;
        private readonly IMapper _autoMapper = autoMapper;
        /// <summary>
        /// Handles the address update by loading the club aggregate,
        ...
        /// </exception>
        public override async Task<ClubDTO> Handle(UpdateAddressCommand request, CancellationToken cancellationToken)
        {
            ...
            club.UpdateAddress(_autoMapper.Map<Address>(request.NewAddress), request.ActorId);
