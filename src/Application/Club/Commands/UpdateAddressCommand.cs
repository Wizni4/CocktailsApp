...
namespace CocktailsApp.Application.Club
{
    ...
    /// <param name="NewAddress">The new address of the club.</param>
    /// <param name="ActorId">
    ...
    /// </param>
    public record UpdateAddressCommand(Guid ClubId, AddressDTO NewAddress, Guid ActorId) : ICommand<ClubDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the new Address of the club.
        /// </summary>
        public AddressDTO NewAddress { get; } = NewAddress;
