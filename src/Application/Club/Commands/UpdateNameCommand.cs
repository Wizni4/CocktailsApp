...
namespace CocktailsApp.Application.Club
{
    ...
    /// <param name="NewName">The new name of the club.</param>
    /// <param name="ActorId">
    ...
    /// </param>
    public record UpdateNameCommand(Guid ClubId, string NewName, Guid ActorId) : ICommand<ClubDTO>
    {
        /// <summary>
