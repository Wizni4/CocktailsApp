...
{
    /// <summary>
    /// Command to remove a cocktail from a club, initiated by another actor (typically an admin or authorized member).
    /// </summary>
    /// <param name="ClubId">The unique identifier of the club where the role is being deleted.</param>
    /// <param name="CocktailId">The unique identifier of the cocktail to delete.</param>
    /// <param name="ActorId">
    ...
    /// </param>
    public record RemoveCocktailCommand(Guid ClubId, Guid CocktailId, Guid ActorId) : ICommand<ClubDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the unique identifier of the cocktail to remove.
        /// </summary>
