...
{
    /// <summary>
    /// Command to remove a permission of a member of a club, initiated by another actor (typically an admin or authorized member).
    /// </summary>
    /// <param name="ClubId">The unique identifier of the club where the role is being deleted.</param>
    /// <param name="MemberId">The unique identifier of the member to whom the permission is being removed.</param>
    /// <param name="Permission">The permission to remove from the member..</param>
    /// <param name="ActorId">
    ...
    /// </param>
    public record RemovePermissionToMemberCommand(Guid ClubId, Guid MemberId, ClubPermission Permission, Guid ActorId) : ICommand<ClubDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the unique identifier of the member to whom the permission is being removed.
        /// </summary>
        public Guid MemberId { get; } = MemberId;

        /// <summary>
        /// Gets Permission to remove from the member.
        /// </summary>
