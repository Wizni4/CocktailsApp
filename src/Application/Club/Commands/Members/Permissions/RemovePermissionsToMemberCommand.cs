...
{
    /// <summary>
    /// Command to remove permissions to a member of a club, initiated by another actor (typically an admin or authorized member).
    /// </summary>
    ...
    /// <param name="Permissions">The permissions to remove from the member..</param>
    /// <param name="ActorId">
    ...
    /// </param>
    public record RemovePermissionsToMemberCommand(
        Guid ClubId,
        Guid MemberId,
