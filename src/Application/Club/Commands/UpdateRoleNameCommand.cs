...
namespace CocktailsApp.Application.Club
{
    ...
    /// <param name="RoleId">The unique identifier of the role where the name is being updated.</param>
    ...
    /// </param>
    public record UpdateRoleNameCommand(Guid ClubId, Guid RoleId, string NewName, Guid ActorId) : ICommand<ClubDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// The unique identifier of the role where the name is being updated.
        /// </summary>
