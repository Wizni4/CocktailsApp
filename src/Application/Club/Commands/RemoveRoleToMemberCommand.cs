...
namespace CocktailsApp.Application.Club
{
    ...
    /// </param>
    public record RemoveRoleToMemberCommand(Guid ClubId, Guid MemberId, Guid RoleId, Guid ActorId) : ICommand<ClubDTO>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the unique identifier of the member to whom the role is being removed.
        /// </summary>
        public Guid MemberId { get; } = MemberId;

        /// <summary>
        /// Gets the unique identifier of the role to remove.
        /// </summary>
