...
namespace CocktailsApp.Domain.Tests.Clubs
{
    [TestFixture]
    public class ClubTest
    {
        ...
        private Guid SetupScenario(PermissionType permission, string scenario)
        {
        ...
        {
            // Arrange
            var permission = PermissionType.AddCocktail;
            var cocktailId = Guid.NewGuid();
        ...
        {
            // Arrange
            var permission = PermissionType.AddMember;
        ...
        {
            // Arrange
            var permission = PermissionType.AddPermissionToRole;
            var permissionAdded = PermissionType.RemoveRoleFromMember;
        ...
        {
            // Arrange
            var permission = PermissionType.RemoveRoleFromMember;
        ...
        public void AddRoleToMember_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            // Arrange
            var permission = PermissionType.AddRoleToMember;
        ...
        {
            // Arrange
            _role.AddPermission(PermissionType.AddRoleToMember, _owner.Id);
        ...
        {
            // Arrange
            var permission = PermissionType.CreateRole;
            var roleName = "Test role";
        ...
        public void DeleteRole_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            // Arrange
            var permission = PermissionType.DeleteRole;
        ...
        {
            // Arrange
            var permission = PermissionType.RemoveCocktail;
        ...
        public void RemoveMember_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            var permission = PermissionType.RemoveMember;
        ...
        {
            // Arrange
            _role.AddPermission(PermissionType.RemoveMember, _owner.Id);
        ...
        public void RemovePermissionFromRole_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            _role.AddPermission(PermissionType.AddCocktail, _owner.Id);

            // Arrange
            var permission = PermissionType.RemovePermissionFromRole;
            var action = (Guid actorId) => _club.RemovePermissionFromRole(_role.Id, PermissionType.AddCocktail, actorId);
            var assert = () =>
            {
                Assert.That(_role.Permissions.Any(p => p.Permission == PermissionType.AddCocktail), Is.False);
            };
        ...
        public void RemovePermissionFromRole_OwnerRole_ThrowUnauthorizedAccessException()
        {
            // Act & Assert
            var exception = Assert.Throws<UnauthorizedAccessException>(() =>
                _club.RemovePermissionFromRole(_ownerRole.Id, PermissionType.AddCocktail, _owner.Id));
        ...
        public void RemovePermissionFromRole_RoleDoesNotHaveThePermission_ThrowKeyNotFoundException()
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() =>
                _club.RemovePermissionFromRole(_role.Id, PermissionType.AddCocktail, _owner.Id));
        ...
        public void RemovePermissionFromRole_RoleNotInClub_ThrowArgumentException()
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() =>
                _club.RemovePermissionFromRole(Guid.NewGuid(), PermissionType.AddCocktail, _owner.Id));
        ...
        public void RemovePermissionFromRole_EmptyRoleId_ThrowArgumentException()
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() =>
                _club.RemovePermissionFromRole(Guid.Empty, PermissionType.AddCocktail, _owner.Id));
        ...
        {
            // Arrange
            _role.AddPermission(PermissionType.RemoveRoleFromMember, _owner.Id);
        ...
        {
            // Arrange
            var newAdress = new Address("Test address ! !", "123", "Somewhere", "12345", "", "FR");
            var permission = PermissionType.ChangeAddress;
            var action = (Guid actorId) => _club.UpdateAddress(
                newAdress.Street,
                newAdress.StreetNumber,
                newAdress.City,
        ...
        public void UpdateDescription_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            var permission = PermissionType.ChangeDescription;
        ...
        public void UpdateName_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            var permission = PermissionType.ChangeName;
        ...
        public void UpdateRoleName_PermissionScenarios(string scenario, bool shouldSucceed)
        {
            ...
            var permission = PermissionType.ChangeRoleName;
        ...
        {
            // Arrange
            var permission = PermissionType.ChangeVisibility;
            var action = (Guid actorId) => _club.UpdateVisibility(Visibility.Public, actorId);
            var assert = () =>
            {
                Assert.That(_club.Visibility, Is.EqualTo(Visibility.Public));
            };
